...
<body>
	<div class="container">
		<div class="taskbar">
			<a href="../index.html" title="Home"><img src="../res/icon/logo.jpg" class="logo"></a>
			<!-- MENU -->
			<div class="menu">
				<ul>
					<a href="home.php?id=1"><li>Bài hát</li></a>
					<a href="home.php?id=2"><li>Ca Sĩ</li></a>
					<a href="home.php?id=3"><li>Nhạc Sĩ</li></a>
					<a href="home.php?id=4"><li>Khán giả</li></a>
				</ul>
			</div>
